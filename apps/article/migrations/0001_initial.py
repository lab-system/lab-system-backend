    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_id', models.IntegerField(default=0, help_text='索引', verbose_name='索引')),
                ...
                ('tags', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='article.Tag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '文章',
